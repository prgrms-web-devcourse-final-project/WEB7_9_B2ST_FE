  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-rose-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/ticket"
              className="px-8 py-4 rounded-full font-bold text-white border border-white/60 hover:bg-white/10 transition-colors"
            >
              공연 둘러보기
            </Link>
          </div>
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8 text-gray-700">
            <div>
              <h4 className="text-gray-900 font-bold mb-4">TT</h4>
