      ...
      <div className="py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-8">내 티켓 선택</h1>
            ...
            <div className="space-y-6">
              ...
              {isFetchingTickets ? (
                ...
                <div className="text-center py-12">
                  ...
                  <Link href="/my-page" className="text-green-600 hover:text-green-700 font-medium">
                    마이페이지에서 확인하기
                  </Link>
                </div>
              ) : (
                <>
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {tradeType === 'EXCHANGE' && (
                        <span className="text-xs text-gray-500">교환은 1장만 선택 가능합니다</span>
                      )}
                    </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  <input
                                    type={tradeType === 'EXCHANGE' ? 'radio' : 'checkbox'}
                                    checked={isSelected}
                                ...
                                {performance && (
                                  <p className="text-sm text-gray-600 ml-6">{performance.title}</p>
                                )}
                              </div>
                            </div>
                          </button>
