...
export const typedLotteryApi = {
  ...
  async getLotterySections(performanceId: number) {
    return typedApiClient.get<"/api/performances/{performanceId}/lottery/section", "get", 200>(
  ...
  async createLotteryEntry(performanceId: number, request: RegisterLotteryEntryRequest) {
    return typedApiClient.post<"/api/performances/{performanceId}/lottery/entry", "post", 201>(
